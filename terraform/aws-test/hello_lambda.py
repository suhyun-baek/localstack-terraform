...
def fn_convert_log_to_json(param):
    '''
        ...
        @Responce Example
            responce = {
                "2020041517" : "{"host": "125.179.14.71", "user": "-", "time": "15/Apr/2020:08:34:22 +0000", "request": "GET /rererldjhkjhjk HTTP/1.1", "status": "404", "size": "209", "referer": "-", "userAgent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.163 Safari/537.36"}\n"
                "2020041518" : "{"host": "125.179.14.71", "user": "-", "time": "15/Apr/2020:09:34:22 +0000", "request": "GET /rererldjhkjhjk HTTP/1.1", "status": "404", "size": "209", "referer": "-", "userAgent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.163 Safari/537.36"}\n"
            }
    '''
    ...
    for index, record in enumerate(param['records']):
        try:
            ...
            print ("err : " + str(traceback.format_exc()))
            param['records'][index]["result"] = "ProcessingFailed"
